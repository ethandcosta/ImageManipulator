...
public class HorizontalFlipTest {
  ...
  public void init() {
    ...
    flipped[0][1] = new RGBPixel(0, 1, 255, 10, 20, 30);
    flipped[0][0] = new RGBPixel(0, 0, 255, 20, 10, 30);
    flipped[1][1] = new RGBPixel(1, 1, 255, 30, 20, 30);
    flipped[1][0] = new RGBPixel(1, 0, 255, 45, 32, 12);
  }
